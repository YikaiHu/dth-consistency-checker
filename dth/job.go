...
// Finder is an implementation of Job interface
...
// Comparator is an implementation of Job interface
...
// Worker is an implementation of Job interface
...
func (c *Comparator) Run(ctx context.Context) {
	...
	log.Printf("Comparator Job Completed in %v\n", end)
}
